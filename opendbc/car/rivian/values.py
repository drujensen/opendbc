...
class CarControllerParams:
  ...
  # 2022 models have a different steering rack theorized to achieve ~half the lateral acceleration
  # of 2023+ at all speeds. Raised STEER_MAX from 250 to 300 to compensate; panda ceiling is 350.
  # Further tuning via torqued measurements recommended after initial testing.
  STEER_MAX = 300
